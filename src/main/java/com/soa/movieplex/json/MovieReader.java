...
public class MovieReader implements MessageBodyReader<Movie> {
    ...
    @Override public Movie readFrom(Class<Movie>type,Type type1, Annotation[]annotations, MediaType mediaType, MultivaluedMap<String,String>multivaluedMap,InputStream inputSteam) throws IOException,WebApplicationException {
