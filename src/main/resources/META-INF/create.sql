...
CREATE TABLE MOVIE_REVIEWS ("ID" INTEGER not null primary key, "MOVIE_ID" INTEGER not null, "CUSTOMER" VARCHAR(75) not null, "RATING" INTEGER not null, "COMMENTS" VARCHAR(200) not null)
ALTER TABLE MOVIE_REVIEWS ADD CONSTRAINT MOVIE_FK FOREIGN KEY ("MOVIE_ID") REFERENCES MOVIES ("ID")
